...
enum
{
	...
	HEADER_GD_SAFEBOX_MONEY 		= 146,
	HEADER_GD_SAFEBOX_CHEQUE 		= 147,
#endif
...
#endif
#ifdef ENABLE_SAFEBOX_MONEY_SYSTEM
	HEADER_DG_SAFEBOX_MONEY 		= 185,
	HEADER_DG_SAFEBOX_CHEQUE 		= 186,
#endif
...
typedef struct SShopItemTable
{
	...
	DWORD		price;	// PC, shop_table_ex.txt »óÁ^z^¸¸ REzë
#ifdef ENABLE_CHEQUE_SYSTEM
	DWORD		cheque;
#endif
